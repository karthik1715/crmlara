...
<head>
	...
	<!-- Fonts and icons -->
	<script src="{{ URL::asset('public/assets/js/plugin/webfont/webfont.min.js') }}"></script>
	<script>
		WebFont.load({
	...
	<link rel="stylesheet" href="{{ URL::asset('public/assets/css/atlantislog.css') }}">
</head>
<body class="login">
			...
			<div class="login-form">
				...
				<form method="POST" action="{{ route('login.post') }}">
					...
					<div class="form-action mb-3">
						<!-- <a href="{{url('/dashboard')}}" class="btn btn-primary btn-rounded btn-login">Sign In</a> -->
						<button type="submit" class="btn btn-primary btn-rounded btn-login">Signin</button>
					</div>
